...
using AngularWebApiAuthExample.WebApis.Providers;
using AngularWebApiAuthExample.WebApis.Results;
...
namespace AngularWebApiAuthExample.WebApis.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        {            
            return RoleManager.Roles.Select(identityRole => identityRole.Name).ToList();
        }
